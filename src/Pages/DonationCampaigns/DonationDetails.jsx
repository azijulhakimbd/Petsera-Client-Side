...
const DonationDetails = () => {
  ...
  const handleDonate = async (e) => {
    ...
    try {
      ...
      if (result.error) {
        ...
        // Update local campaign state with new totalDonated and donators
        setCampaign((prev) => ({
          ...prev,
          totalDonated: res.data.totalDonated,
          donators: [...(prev.donators || []), {
            name: user?.displayName || "Anonymous",
            email: user?.email || "user@example.com",
            amount,
  ...
  return (
    <section className="max-w-4xl mx-auto px-4 py-25">
      ...
      <button
        className="btn rounded-2xl p-3 bg-green-700 hover:bg-green-800 mx-auto btn-primary"
      ...
      >
        ...
        <form onSubmit={handleDonate} className="space-y-4">
          ...
          <button
            type="submit"
            className="btn rounded-2xl p-3 bg-green-700 hover:bg-green-800 mx-auto mt-4"

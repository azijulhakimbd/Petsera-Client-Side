...
const DonationDetails = () => {
  ...
  const handleDonate = async (e) => {
    ...
    if (result.error) {
      ...
      if (result.paymentIntent.status === "succeeded") {
        // Record donation
        await axiosSecure.post("/donations/donate", {
          campaignId: id,
          amount,
          donor: {
  ...
  return (
    <section className="max-w-4xl mx-auto px-4 py-25">
      ...
      <img src={campaign.image} alt="" className="w-full h-80 object-cover rounded-lg mb-6" />
      ...
      <button className="btn rounded-2xl p-3 bg-green-700 hover:bg-green-800 mx-auto btn-primary" onClick={() => setModalOpen(true)}>
        Donate Now
      </button>
      ...
      >
        ...
        <form onSubmit={handleDonate} className="space-y-4">
          ...
          <button type="submit" className="btn rounded-2xl p-3 bg-green-700 hover:bg-green-800 mx-auto mt-4">
            Submit Donation
          </button>
        </form>
      </Modal>
